...
<head>
    ...
    <link href="${basePath}/botui/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
    <link href="${basePath}/botui/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">

    <!-- Morris -->
    <link href="${basePath}/botui/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="${basePath}/botui/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">

    <link href="${basePath}/botui/css/animate.min.css" rel="stylesheet">
    <link href="${basePath}/botui/css/style.min.css?v=4.0.0" rel="stylesheet"><base target="_blank">
...
<body class="gray-bg">
    ...
    <script src="${basePath}/botui/js/plugins/flot/jquery.flot.js"></script>
    <script src="${basePath}/botui/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${basePath}/botui/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${basePath}/botui/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${basePath}/botui/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="${basePath}/botui/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="${basePath}/botui/js/demo/peity-demo.min.js"></script>
    <script src="${basePath}/botui/js/content.min.js?v=1.0.0"></script>
    <script src="${basePath}/botui/js/plugins/jquery-ui/jquery-ui.min.js"></script>
    <script src="${basePath}/botui/js/plugins/gritter/jquery.gritter.min.js"></script>
    <script src="${basePath}/botui/js/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="${basePath}/botui/js/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="${basePath}/botui/js/demo/sparkline-demo.min.js"></script>
    <script>
