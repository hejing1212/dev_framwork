					...
					<tbody>
						<tr>
							...
							<td class="kv-content"><input class="easyui-textbox"
								type="text" name="categoryName" data-options="required:true,missingMessage:'请输入商品分类名称！'" style="height:30px"/></td>

							<td class="kv-label">排序</td>
							<td class="kv-content"><input class="easyui-textbox"
								type="text" name="sort" value="0" data-options="required:true,missingMessage:'排序编号！'" style="height:30px"/></td>
						</tr>
