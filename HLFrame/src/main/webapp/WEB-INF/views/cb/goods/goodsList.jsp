...
<body>
	<div class="container">
		<table id="dg" style="width: 100%; height: 554px" title="系统商品列表"
		...
		<div id="tb" style="padding: 0 30px;">
			<div class="conditions">
				...
				<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="window.parent.mainPlatform._createWindows('添加系统商品','${basePath}/cb/goods/goodsAdd.html','icon-add','sys_goodsAdd');"> 新增</a>
				<a href="javascript:void(0)" onclick="editGoods();" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改</a>
				<a href="javascript:void(0)" onclick="delGoods();" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'">删除</a>  
