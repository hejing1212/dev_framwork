					...
					<tbody>
						<tr>
							...
							<td class="kv-content"><input class="easyui-textbox"
								type="text" name="name" data-options="required:true,missingMessage:'请输入档口名称！'" style="height:30px"/></td>

							<td class="kv-label">所属商家 </td>
							<td class="kv-content"><input class="easyui-textbox" editable="false"
								type="text" id="epnName" name="epnName"  data-options="required:true,missingMessage:'选择档口所属商家！'" style="height:30px"  />
								<input type="hidden" name="epNo" id="epNo" />								
