...
<body>
	<div class="container">
		...
		<table id="dg" style="width: 100%; height: 554px" title="全体供应商列表"
			...
			<thead>
				<tr>
					<th field="userid" width="160" align="center">编号</th>
					...
					<th field="permission" width="130" align="center">权限标识</th>
					<th field="isshow" width="100" align="center">是否显示</th>
					<th field="menu_icon" width="100" align="center">图标</th>
