package com.hy.sys.core.hibernate.type;
...
public class ObjectSerializeUserType implements UserType, Serializable {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner)
		...
		try {
			...
			ois = new ObjectInputStream(new ByteArrayInputStream(Hex.decode(hexStr.toCharArray())));
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session)
		...
		if (value == null) {
			...
			try {
				...
				String hexStr = Hex.encodeToString(objectBytes);
